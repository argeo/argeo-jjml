...
TP_GGML_OLDEST=v0.21.0
TP_LLAMA_OLDEST=v0.2.0
TP_WHISPER_OLDEST=v1.9.3

TP_GGML_DEBIAN=v0.22.0
TP_LLAMA_DEBIAN=v0.2.0
TP_WHISPER_DEBIAN=v1.9.3

TP_GGML_LATEST=v0.22.0
TP_LLAMA_LATEST=v0.3.0
TP_WHISPER_LATEST=v1.9.3
...
ifeq ($(MSYSTEM),CLANG64)
	...
	$(CMAKE) -B $(BUILD_BASE) . \
		...
		-DCMAKE_EXPORT_COMPILE_COMMANDS=ON $(BUILD_BASE) \
		\
		$(JJML_COMPILER) \
		$(JJML_SSL) \
